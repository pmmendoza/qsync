...
class SurveyMenuScreen(Screen):
    ...
    def _entries(self) -> list[SurveyMenuEntry]:
        return [
            ...
            SurveyMenuEntry("Inspect question payload", quick_action="edit-inspect-question", detail_lines=("Inspect one cached question payload (read-only).",)),
            SurveyMenuEntry("Push one question from cache", quick_action="edit-push-question", detail_lines=("Push one cached question payload to Qualtrics.",)),
            SurveyMenuEntry("Stage by QID (items/js/translations)", quick_action="edit-stage-by-qid", detail_lines=("Build a QID scope and stage selected dimensions.",), requires_default_account=True),
            ...
            SurveyMenuEntry("── Create, Copy, Slice & Compare ──", section=True, detail_lines=("Create, derive and verify survey copies.",)),
            SurveyMenuEntry("Create survey", quick_action="copy-create", detail_lines=("Create a new inactive survey.",)),
            ...
            SurveyMenuEntry("── Bulk & Master ──", section=True, detail_lines=("Survey master bulk workflows + QID-stage helper.",)),
            SurveyMenuEntry("Survey master workflows", quick_action="bulk-master", detail_lines=("Pull/preview/stage/push/rollback survey master changes.",), requires_default_account=True),
