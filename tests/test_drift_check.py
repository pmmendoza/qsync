...
class TestCheckDrift:
    ...
    def test_no_drift_when_cache_matches_api(self):
        ...
        with patch("qsync.drift_check.load_cached_survey", return_value=mock_cached), \
             patch("qsync.drift_check.fetch_survey_definition_live", return_value=mock_live):
    ...
    def test_missing_cache_treated_as_drift(self):
        ...
        with patch("qsync.drift_check.load_cached_survey", side_effect=FileNotFoundError()):
    ...
    def test_error_checking_drift_proceeds_safely(self):
        ...
        with patch("qsync.drift_check.load_cached_survey", side_effect=Exception("API error")):
...
class TestEnforceNoDrift:
    ...
    def test_no_drift_passes(self):
        ...
        with patch("qsync.drift_check.check_drift", return_value=mock_report), \
