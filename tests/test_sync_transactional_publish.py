...
class TestCompositePublishDescription:
    ...
    def test_generate_description_multiple_dimensions(self):
        ...
        dimension_results = {
            ...
            "js": DimensionSyncResult(
                dimension="js", success=True, applied_changes=True
            ),
            "translations": DimensionSyncResult(
                dimension="translations", success=True, applied_changes=True
            ),
        }
    ...
    def test_generate_description_failed_dimensions_excluded(self):
        ...
        dimension_results = {
            ...
            "js": DimensionSyncResult(
                dimension="js", success=False, error_message="Push failed"
            ),
        }
...
class TestDisplayPushReport:
    ...
    def test_display_report_partial_failure(self, capsys):
        ...
        dimension_results = {
            ...
            "js": DimensionSyncResult(
                dimension="js", success=False, error_message="Network error"
            ),
        }
...
class TestOrchestratedPublish:
    ...
    def test_publish_skipped_on_failure(self):
        ...
        dimension_results = {
            ...
            "js": DimensionSyncResult(
                dimension="js", success=False, error_message="Error"
            ),
        }
